...
- packet-shaped route delivery, asynchronous acknowledgement handling, and destination-side receive state with pool-backed swap execution on the mock Osmosis target
