...
SOURCE_RPC_ADDR="${AEGISLINK_RLY_SOURCE_RPC_ADDR:-http://127.0.0.1:26657}"
SOURCE_RPC_WS_ADDR="${AEGISLINK_RLY_SOURCE_RPC_WS_ADDR:-ws://127.0.0.1:26657/websocket}"
SOURCE_GRPC_ADDR="${AEGISLINK_RLY_SOURCE_GRPC_ADDR:-http://127.0.0.1:9090}"
